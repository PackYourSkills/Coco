...
ActiveRecord::Schema.define(version: 20161118105311) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "country"
    t.string   "website"
    t.string   "photo",                  default: "http://res.cloudinary.com/pack-your-skills/image/upload/v1479311735/Coco-seul_cc1gzz.png"
